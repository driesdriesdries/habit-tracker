...
<div class="plugin-container">
    ...
    // Sort the habit completion data by completion rate (ascending order)
    ...
    // Get the three weakest habits
    $weakestHabits = array_slice($habitCompletionData, 0, 3);

    // Initialize a variable to hold the <ul> of weakest habits
    $weakestHabitsList = '<ul>';

    // Iterate over the weakest habits to create the list items
    foreach ($weakestHabits as $habit) {
        // Calculate the completion rate
        $completionRate = ($habit['completed_days'] / $habit['goal_amount']) * 100;
        // Append the habit name and completion rate to the list
        ...
        <div class="dash-panel">
            ...
            <div class="panel-group component">
                ...
                <div class="panel">
                    ...
                    <?php 
                        // Echo out the <ul> of weakest habits
